...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'coordinator_pbc = remroc.coordinator_pbc:main',
            'coordinator_ha_cbs = remroc.coordinator_ha_cbs:main',
            'human_pose_publisher = remroc.human_pose_publisher:main',
            'metrics_recorder = remroc.metrics_recorder:main'
        ],
    },
)
